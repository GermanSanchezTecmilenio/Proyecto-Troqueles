...
const views = {
  ...
  altas: { title: "Altas", exportable: false, render: renderAltas },
  clientes: { title: "Clientes", exportable: true, render: renderClientes },
  proveedores: { title: "Proveedores", exportable: true, render: renderProveedores },
  piezas: { title: "Piezas", exportable: true, render: renderPiezas },
  ordenes: { title: "Ordenes de trabajo", exportable: true, render: renderOrdenes },
  monitor: { title: "Monitor de produccion", exportable: true, render: renderMonitor },
  operadores: { title: "Operadores", exportable: true, render: renderOperadores },
  tiempos: { title: "Captura de tiempos", exportable: true, render: renderTiempos },
  requisiciones: { title: "Requisiciones", exportable: true, render: renderRequisiciones },
  ordenesCompra: { title: "Ordenes de compra", exportable: true, render: renderOrdenesCompra },
  almacen: { title: "Almacen basico", exportable: true, render: renderAlmacen },
  remisiones: { title: "Remisiones", exportable: true, render: renderRemisiones },
  reportes: { title: "Reportes", exportable: true, render: renderReportes },
  ajustes: { title: "Ajustes", exportable: false, render: renderAjustes }
};
